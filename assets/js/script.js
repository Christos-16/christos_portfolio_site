...
const translations = {
  ...
  el: {
    ...
    'about.whoText': 'Είμαι ο <strong>Christos Anastasiou</strong>, <strong>Junior Software Developer</strong> με <strong>δύο χρόνια εμπειρίας</strong> στην <strong>Enchatted</strong>. Δημιουργώ scalable web εφαρμογές με PHP, Laravel, JavaScript και React. Δουλεύω σε full-stack ανάπτυξη, Shopify integration και IoT λύσεις.',
    ...
    'about.educationText2': 'Ολοκλήρωσα το <a href="https://msc.cs.uowm.gr/" target="_blank" style="color: #e08649;"><strong>Μεταπτυχιακό στις Σύγχρονες Τεχνολογίες Πληροφορικής και Υπηρεσιών</strong></a> (βαθμός 9.24) με διπλωματική εργασία στο Machine Learning για smart building energy forecasting. Benchmarked linear, boosting (XGBoost, LightGBM) και deep learning μοντέλα σε 29M IoT sensor readings για energy demand prediction. Μαζί με την εμπειρία μου στην Enchatted έχω δεξιότητες σε full-stack ανάπτυξη, ML pipelines, IoT systems, ενοποίηση δεδομένων και παραγωγικά συστήματα.',
    'about.workTitle': 'Τι κάνω',
    'about.workIntro': 'Στην Enchatted συμμετέχω σε διαφορετικά έργα για e-commerce, εκπαιδευτική τεχνολογία και άλλα domains. Είμαι παρών σε όλα τα στάδια – από τον σχεδιασμό αρχιτεκτονικής έως την παράδοση παραγωγικού κώδικα. Ενδεικτικά:',
    ...
    'experience.work1.point1': 'Σχεδιασμό και ανάπτυξη full-stack web εφαρμογών με PHP, Laravel, JavaScript και React',
    ...
    'contact.subtitle': 'Επικοινωνήστε μαζί μου',
