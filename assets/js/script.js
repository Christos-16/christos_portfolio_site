...
const translations = {
  en: {
    ...
    'about.educationText2': 'I\'ve recently completed my <strong>Master\'s degree in Modern Information Technologies and Services</strong> (Grade: 9.24) from the same university. My thesis advanced IoT system integration with a focus on scalable, real-world solutions for smart building ecosystems. Combined with my professional experience at Enchatted, I\'ve developed strong expertise in web development, IoT systems, data integration, and building robust production systems.',
    'about.workTitle': 'What I Do',
    'about.workIntro': 'As a junior software developer at Enchatted, I contribute to diverse, mission-critical projects across healthcare, e-commerce, and educational technology. I\'m involved in every stage—from designing system architecture to deploying production code. Here are some portfolio highlights:',
    ...
    'portfolio.title': 'My Portfolio - Featured Projects',
    ...
    'projectTimeline.intro': 'Explore the portfolio journey of Christos Anastasiou—from junior developer projects to professional work. Open a card to see the wins.',
  ...
  el: {
    ...
    'hero.subtitle': 'Junior Software Developer',
    'hero.description': 'Δημιουργώ web εφαρμογές και εξερευνώ IoT λύσεις.<br>Αυτή τη στιγμή δουλεύω στην <strong>Enchatted</strong> και συνεχίζω τις σπουδές μου στο <strong>Πανεπιστήμιο Δυτικής Μακεδονίας</strong>.',
    ...
    'about.whoText': 'Είμαι ο <strong>Christos Anastasiou</strong>, <strong>Junior Software Developer</strong> με <strong>δύο χρόνια εμπειρίας</strong> στην <strong>Enchatted</strong>. Δημιουργώ scalable web εφαρμογές με PHP, Laravel, JavaScript και React. Δουλεύω σε web development, Shopify integration και IoT λύσεις.',
    'about.educationTitle': 'Σπουδές',
    'about.educationText1': 'Αποφοίτησα από το <a href="https://cs.uowm.gr/" target="_blank" style="color: #e08649;">Τμήμα Πληροφορικής του Πανεπιστημίου Δυτικής Μακεδονίας</a> (βαθμός 7.34) με πτυχιακή <strong>«Smart Building Automation with Z-Wave»</strong>, όπου εμβάθυνα στην αρχιτεκτονική IoT και στην ολοκλήρωση έξυπνων συστημάτων.',
    'about.educationText2': 'Ολοκλήρωσα το <a href="https://msc.cs.uowm.gr/" target="_blank" style="color: #e08649;"><strong>Μεταπτυχιακό στις Σύγχρονες Τεχνολογίες Πληροφορικής και Υπηρεσιών</strong></a> (βαθμός 9.24) με διπλωματική εργασία στο Machine Learning για smart building energy forecasting. Benchmarked linear, boosting (XGBoost, LightGBM) και deep learning μοντέλα σε 29M IoT sensor readings για energy demand prediction. Μαζί με την εμπειρία μου στην Enchatted έχω δεξιότητες σε web development, ML pipelines, IoT systems, ενοποίηση δεδομένων και παραγωγικά συστήματα.',
    'about.workTitle': 'Τι κάνω',
    'about.workIntro': 'Ως junior software developer στην Enchatted, συμμετέχω σε διαφορετικά έργα για e-commerce, εκπαιδευτική τεχνολογία και άλλα domains. Είμαι παρών σε όλα τα στάδια – από τον σχεδιασμό αρχιτεκτονικής έως την παράδοση παραγωγικού κώδικα. Portfolio highlights:',
    ...
    'about.philosophyText1': 'Προσπαθώ να γράφω καθαρό, συντηρήσιμο κώδικα και να ξέρω το «γιατί» πίσω από κάθε απόφαση – από σχεδιασμό API έως βελτιστοποίηση βάσης δεδομένων.',
    ...
    'about.philosophyText3': '<strong>Ζητώ projects όπου μπορώ να μάθω, να συμβάλλω με νόημα και να δουλέψω με ομάδες που ενδιαφέρονται για ποιότητα.</strong>',
    ...
    'services.shopify.title': 'Shopify',
    'services.shopify.text': 'Δημιουργώ και προσαρμόζω καταστήματα Shopify με προηγμένες δυνατότητες και καλή εμπειρία χρήστη.',
    'tech.title': 'Τεχνολογίες & Εργαλεία',
    'skills.title': 'Δεξιότητες & Εξειδίκευση',
    'portfolio.title': 'Το Portfolio μου - Επιλεγμένα έργα',
    ...
    'highlights.item3.text': 'Ολοκλήρωσα το Μεταπτυχιακό σε Σύγχρονες Τεχνολογίες Πληροφορικής με έμφαση σε Machine Learning και IoT για smart building energy forecasting.',
    ...
    'highlights.item5.text': 'Έχω δουλέψει σε IoT λύσεις, web εφαρμογές, e-commerce, εκπαιδευτικές πλατφόρμες και data integration projects.',
    ...
    'projectTimeline.intro': 'Εξερεύνησε το portfolio του Χρήστου Αναστασίου — από junior projects μέχρι επαγγελματικά έργα. Άνοιξε τις κάρτες για λεπτομέρειες.',
    ...
    'projectTimeline.item2.title': 'Smart Building & IoT Research - Διπλωματική',
    ...
    'projectTimeline.item2.modalTitle': 'Αποτελέσματα Master\'s Thesis',
    'projectTimeline.item2.modalIntro': 'Ανάλυση και βελτιστοποίηση έξυπνων κτιρίων με ML και IoT τεχνολογίες.',
    'projectTimeline.item2.point1': 'Επεξεργασία 29M ενδείξεων από 52 Z-Wave sensors σε 5 energy subsystems.',
    'projectTimeline.item2.point2': 'Benchmarking 9 αλγορίθμων (linear, boosting, deep learning).',
    'projectTimeline.item2.point3': 'Walk-forward validation με RMSE, MAE, wMAPE και MASE metrics.',
    'projectTimeline.item2.point4': 'Δημιουργία explainability notebooks και energy savings scenarios.',
    'projectTimeline.item2.point5': 'Παράδοση reproducible code, docs και multimodal data roadmap.',
    ...
    'projectTimeline.item3.title': 'Community & WordPress Sites - Κοινότητα',
    'projectTimeline.item3.summary': 'Συντήρηση φοιτητικών και κοινοτικών WordPress sites με σύγχρονη content strategy και accessibility.',
    'projectTimeline.item3.tag1': 'WordPress',
    'projectTimeline.item3.tag2': 'Content',
    'projectTimeline.item3.tag3': 'Accessibility',
    'projectTimeline.item3.modalTitle': 'Κοινοτικά WordPress Projects',
    'projectTimeline.item3.modalIntro': 'Volunteer-led ανανέωση φοιτητικών και τοπικών κοινοτικών sites.',
    'projectTimeline.item3.point1': 'IEEE Student Branch ανανέωση με event coverage, sponsors tracking και automated updates.',
    'projectTimeline.item3.point2': 'Τοπικές οργανώσεις με custom themes, donation flows και content management tools.',
    ...
    'projectTimeline.item4.title': 'Foundations & Experiments - Βάσεις',
    'projectTimeline.item4.summary': 'Πανεπιστημιακά και προσωπικά projects που έχτισαν τα θεμέλια μου σε UI και delivery.',
    'projectTimeline.item4.tag1': 'React',
    'projectTimeline.item4.tag2': 'UI/UX',
    'projectTimeline.item4.tag3': 'Prototyping',
    'projectTimeline.item4.modalTitle': 'Θεμελιώδη Πειράματα',
    'projectTimeline.item4.modalIntro': 'Πανεπιστημιακά και προσωπικά prototypes που έσχημάτισαν την προσέγγισή μου σε software design και delivery.',
    ...
    'experience.workTitle': 'Εργασιακή Εμπειρία',
    'experience.work1.title': 'Junior Software Developer',
    'experience.work1.company': 'Enchatted',
    'experience.work1.date': '11/2023 — Present',
    'experience.work1.point1': 'Σχεδιασμό και ανάπτυξη web εφαρμογών με PHP, Laravel, JavaScript και React',
    'experience.work1.point2': 'Κατασκευή e-commerce λύσεων σε Shopify με custom backend integrations και GraphQL APIs',
    'experience.work1.point3': 'Αρχιτεκτονική και βελτιστοποίηση βάσεων δεδομένων, σχεδιασμό REST APIs και υλοποίηση real-time data pipelines',
    'experience.work1.point4': 'Εργασία σε διάφορα projects για e-commerce, εκπαιδευτική τεχνολογία και άλλα domains',
    'experience.work1.point5': 'Συνεργασία με cross-functional ομάδες για παράδοση scalable και production-ready λύσεων',
    'experience.work2.title': 'Sales Advisor',
    'experience.work2.company': 'Telectron Hellas - Vodafone',
    'experience.work2.date': '09/2021 — 02/2022',
    'experience.work2.point1': 'Πωλήσεις τηλεφωνικών πακέτων και τεχνολογικών gadgets',
    'experience.work2.point2': 'Επικοινωνία με πελάτες και επίλυση προβλημάτων',
    'experience.work2.point3': 'Γνώση προϊόντων και excellence στο customer service',
    'experience.educationTitle': 'Εκπαίδευση',
    'experience.edu1.title': 'Master of Science - Modern Information Technologies and Services',
    'experience.edu1.company': 'University of Western Macedonia',
    'experience.edu1.date': '10/2023 — 10/2025',
    'experience.edu1.grade': 'Τελικός Βαθμός: 9.24',
    'experience.edu1.thesis': '<strong>Διπλωματική:</strong> Μελέτη Machine Learning για smart building energy forecasting με ανάλυση 29M IoT sensor readings και benchmarking γραμμικών, boosting και deep learning αλγορίθμων.',
    'experience.edu2.title': 'Bachelor of Science - Computer Science',
    'experience.edu2.company': 'University of Western Macedonia',
    'experience.edu2.date': '10/2019 — 10/2023',
    'experience.edu2.grade': 'Τελικός Βαθμός: 7.34',
    'experience.edu2.thesis': '<strong>Πτυχιακή:</strong> "Smart Building Automation with Z-Wave: A Case Study of IoT Integration and Management" — Εκτεταμένη μελέτη αρχιτεκτονικής IoT, υλοποίησης Z-Wave protocol και πρακτικών συστημάτων αυτοματισμού έξυπνων κτιρίων.',
    'contact.title': 'Επικοινωνία',
    'contact.subtitle': 'Επικοινωνήστε με τον Χρήστο Αναστασίου',
    'contact.text': 'Ενδιαφέρομαι πάντα για νέα projects και ευκαιρίες συνεργασίας.',
    'contact.emailLabel': 'Email',
    'contact.emailValue': 'anastasiouxrhstos <span style="font-style: italic;">at</span> gmail.com',
    'contact.phoneLabel': 'Τηλέφωνο',
    'contact.phoneValue': '+30 697 814 2511',
    'contact.locationLabel': 'Τοποθεσία',
    'contact.locationValue': 'Καστοριά, Ελλάδα',
    'contact.form.namePlaceholder': 'Το όνομά σας',
    'contact.form.nameError': 'Παρακαλώ εισάγετε το όνομά σας',
    'contact.form.emailPlaceholder': 'Το email σας',
    'contact.form.emailError': 'Παρακαλώ εισάγετε ένα έγκυρο email',
    'contact.form.messagePlaceholder': 'Το μήνυμά σας',
    'contact.form.messageError': 'Παρακαλώ εισάγετε ένα μήνυμα',
    ...
    'footer.tagline': 'Χρήστος Αναστασίου - Δημιουργημένο με αγάπη για εξαιρετικές web εμπειρίες.',
    'lang.button': 'EN',
